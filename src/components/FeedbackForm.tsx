...
function FeedbackForm() {
  return (
    ...
    // <Card className="mx-4 lg:mx-auto lg:max-w-2xl">
    //   <CardHeader>
    ...
    //           <RadioGroup
    //             id="rating"
    //             className="flex flex-wrap justify-center lg:justify-start space-x-2 lg:space-x-4"
    //             required
    //           >
    //             {[1, 2, 3, 4, 5].map((value) => (
    //               <div key={value} className="flex items-center space-x-2">
    ...
    //         </div>
    //         <div className="flex flex-col space-y-1.5">
    //           <label htmlFor="comment" className="text-base lg:text-lg">
    //             Nhận xét
    //           </label>
    //           <Textarea
    //             id="comment"
