...
function HomePage() {
  return (
    <div className="text-white">
      <div className="w-full h-screen bg-home-bg bg-cover bg-opacity-50 bg-blend-overlay bg-black flex items-center justify-center flex-col gap-2 lg:gap-4 text-center p-4">
        ...
        <img
          src="https://www.cssigniter.com/demos/carbone/wp-content/uploads/sites/9/2021/01/divider.svg"
          alt="Home Background"
      ...
      <div className="grid text-black py-24 grid-cols-1 px-10 lg:grid-cols-2 lg:gap-8 lg:px-40 ">
        ...
        <div>
          <img src={banhmi} alt="Bánh mì chay" className="object-cover" />
        </div>
      </div>

      <div className="bg-orange-bg w-full h-[92vh] bg-cover bg-no-repeat bg-opacity-50 bg-blend-overlay bg-black flex items-center justify-center flex-col gap-2 text-center">
      ...
      <div className="grid text-black grid-cols-1 py-24 px-10 lg:px-40 lg:grid-cols-2 lg:gap-8 ">
        <div className="mb-4 lg:mb-0">
          <img src={customer} alt="Khách hàng" className="object-cover" />
        </div>
        <div className="flex flex-col gap-2">
      ...
      <div className="bg-time-bg w-full h-[92vh] bg-cover bg-no-repeat bg-opacity-50 bg-blend-overlay bg-black flex items-center justify-center flex-col gap-2 text-center">
